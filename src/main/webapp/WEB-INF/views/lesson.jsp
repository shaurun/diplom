...
<div class="container">
    ...
    <c:if test="${!empty listWords}">
        <table class="table table-striped">
            <thead>
            <h2>Словарь урока</h2>
            <span type="button" class="btn btn-success pull-right"><a href="<c:url value='/exercises/lesson/${lesson.id}'/>">Начать упражнение 1</a></span>
            <span type="button" class="btn btn-success pull-right"><a href="<c:url value='/exercises/lesson/${lesson.id}?inverse'/>">Начать упражнение 2</a></span>
            <tr>
                <th>Слово</th>
                <th>Значение</th>
